...
class BaseTrainer:
    ...
    def train(self):
        ...
        if isinstance(self.args.device, str) and self.args.device.startswith("xla"):
            import torch_xla
    ...
    def _do_train(self, world_size=1):
        ...
        self.model, self.optimizer, self.train_loader, self.scheduler = accelerator.prepare(self.model, self.optimizer, self.train_loader, self.scheduler)
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, batch in enumerate(self.train_loader):
                ...
                self.optimizer.step() # accelerator does gradient accu step

                # Optimize - https://pytorch.org/docs/master/notes/amp_examples.html
                #if ni - last_opt_step >= 8:
                #    print("STEPPITY")
